        ...
        return (
            <BrowserRouter>
                <div className="container-fluid w-100 p-0">
                    <section id="header" className="w-100 relative text-left p-5" style={{background: "url(https://i.imgur.com/whL2fPL.jpg) no-repeat fixed", backgroundSize: "110%", backgroundPosition: "20% 100%", position: "relative"}}>
                        <div className="row">
                    ...
                    <section id="results" className="mt-5" style={{position: "relative"}}>
                        ...
                        <div className="w-25 m-auto">                
                            <div className="media text-left pb-5">
                                <img className="mr-3 img-thumbnail rounded" src="https://i.imgur.com/Dztt5tD.jpg" width="128px" alt="Generic placeholder" />
                                <div className="media-body">
                                    <h5 className="mt-0">Mariah Skinner</h5>
                            ...
                            <div className="media text-left pb-5">
                                <img className="mr-3 img-thumbnail rounded" src="https://i.imgur.com/BUdKxPK.jpg" width="128px" alt="Generic placeholder" />
                                <div className="media-body">
                            ...
                            <div className="media text-left">
                                <img className="mr-3 img-thumbnail rounded" src="https://i.imgur.com/eXhuhbI.jpg" width="128px" alt="Generic placeholder" />
                                <div className="media-body">
                    ...
                    <section id="pricing" className="text-light pt-5 mt-5 pb-5" style={{background: "linear-gradient(45deg, rgba(18,18,18,1) 0%, rgba(47,47,47,1) 100%)"}}>
                        <h1 className="mt-5">PLANS & PRICING</h1>
